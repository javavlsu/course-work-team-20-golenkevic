    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/", "/auth", "/auth/**", "/catalog", "/product/**", "/brands", "/brand/*/logo", "/main.css", "/css/**", "/js/**", "/images/**", "/photoformain/**", "/brends/**", "/gallery/**", "/api/gallery/**", "/product/*/image", "/error").permitAll()
